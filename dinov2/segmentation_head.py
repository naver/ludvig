...
class BNHead(BaseDecodeHead):
    ...
    def __init__(self, in_channels, in_index, resize_factors=None, **kwargs):
    ...
    def _transform_inputs(self, inputs):
        ...
        if self.input_transform == "resize_concat":
            ...
            # print("before resize", *(x.shape for x in inputs))
            if self.resize_factors is not None:
                ...
                # print("after resize", *(x.shape for x in inputs))
            upsampled_inputs = [
