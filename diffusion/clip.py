...
class GraphDiffusionCLIP(GraphDiffusion):
    ...
    def __call__(self, **kwargs):
        ...
        return self.run_diffusion(similarities, unary_term=reg_similarities, **kwargs)
    ...
    def construct(self):
        ...
        self.mask = torch.stack(
            [r > filters.threshold_otsu(r[r > 0.5].cpu().numpy()) for r in self.nrel]
        )
    ...
    def trace_f(self, f, t):
        ...
        save_img(
            ...
            viz_normalization(feat, clip=1).squeeze(),
            text=f"Step {t+1}",
            font_size=40,
        )
